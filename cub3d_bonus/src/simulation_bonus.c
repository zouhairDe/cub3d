...
/*   Updated: 2025/02/09 15:25:46 by zouddach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	simulate(t_game *game)
{
	...
	mlx_put_image_to_window(game->mlx.mlx, game->mlx.win, game->mlx.data.img, 0,
		0);
	mlx_put_image_to_window(game->minimap.img, game->mlx.win, game->minimap.img,
		0, 0);
	mlx_put_image_to_window(game->mlx.mlx, game->mlx.win, game->sprites_image,
		0, 0);
